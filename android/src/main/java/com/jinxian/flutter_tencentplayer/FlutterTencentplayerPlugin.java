    ...
    private static class TencentPlayer implements ITXVodPlayListener {
        ...
        TencentPlayer(
            ...
            if (call.argument("cachePath") != null) {
                mPlayConfig.setCacheFolderPath(call.argument("cachePath").toString());
//        mPlayConfig.setCacheFolderPath(Environment.getExternalStorageDirectory().getPath() + "/nellcache");
...
//      Toast.makeText(context, "hahahah" + call.argument("progressInterval"), Toast.LENGTH_LONG).show();
    ...
    public void onMethodCall(MethodCall call, Result result) {
        ...
        switch (call.method) {
            ...
            case "create":
                ...
                TencentPlayer player = new TencentPlayer(registrar.context(), eventChannel, handle, call, result);
